...
public class Guest extends Person implements Serializable
{
    ...
    public Guest(String firstName, String lastName, int personAge, String personEmail, String personNumber, String bankAccountNo, int bankAccountPin) 
    {
    ...
    public void setBankAccountPin(int bankAccountPin)
    {
        this.bankAccountPin = bankAccountPin;
    }
